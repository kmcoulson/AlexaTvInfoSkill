...
namespace AlexaTVInfoSkill.Service.Model
{
    ...
    public class AlexaResponse
    {
        ...
        public AlexaResponse(string outputSpeechText, string cardTitle) : this()
        {
            Response.OutputSpeech.Text = outputSpeechText;
        ...
        public AlexaResponse(string outputSpeechText, string cardTitle, string cardContent) : this()
        {
